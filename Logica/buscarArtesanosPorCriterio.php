<?php
	...
	{
		$artesano=$lista[$i];
		$array2 = array('idArtesano'=>$artesano->getIdArtesano(),'nombre' => utf8_encode($artesano->getNombre()),'nroDoc'=>$artesano->getNroDoc(),'direccion'=>utf8_encode($artesano->getDireccion()),'telefono'=>$artesano->getTelefono(),'celular'=>$artesano->getCelular(),'email'=>$artesano->getEmail(),'ciudad'=>$artesano->getCiudad(),'departamento'=>$artesano->getDepartamento());
		$array1[]=$array2;
	}
	$array3["exito"]=1;
