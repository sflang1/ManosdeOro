<?php
 ...
 /**
  * Stand Data Access Object (DAO).
  * This class contains all database handling that is needed to 
  * permanently store and retrieve Stand object instances. 
  */
...
class StandDao {
     ...
     */
    function getObject($conn, $idStand) {

          $valueObject = $this->createValueObject();
          $valueObject->setIdStand($idStand);
    ...
    function load($conn, $valueObject) {
          ...
          if (!$valueObject->getIdStand()) {
               //print "Can not select without Primary-Key!";
               return false;
          }

          $sql = "SELECT * FROM stand WHERE (idStand = ".$valueObject->getIdStand().") "; 
    ...
    function loadAll($conn) {
          ...
          $sql = "SELECT * FROM stand ORDER BY idStand ASC ";
    ...
    function create($conn, $valueObject) {
          ...
          $sql = "INSERT INTO stand (  idArtesano, reservado) VALUES ( ";
          $sql = $sql."".$valueObject->getIdArtesano().", ";
          $sql = $sql."".$valueObject->getReservado().") ";
    ...
    function save($conn, $valueObject) {
          ...
          $sql = "UPDATE stand SET idArtesano = ".$valueObject->getIdArtesano().", ";
          $sql = $sql."reservado = ".$valueObject->getReservado()."";
          $sql = $sql." WHERE (idStand = ".$valueObject->getIdStand().") ";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function delete($conn, $valueObject) {
          ...
          $sql = "DELETE FROM stand WHERE (idStand = ".$valueObject->getIdStand().") ";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function searchMatching($conn, $valueObject) {
          ...
          $first = true;
          $sql = "SELECT * FROM stand WHERE 1=1 ";
          ...
          if ($valueObject->getReservado() != 0) {
              if ($first) { $first = false; }
              $sql = $sql."AND reservado = ".$valueObject->getReservado()." ";
          }


          $sql = $sql."ORDER BY idStand ASC ";
    ...
    function singleQuery($conn, $sql, $valueObject) {
          ...
          if ($row = $conn->nextRow($result)) {
                   ...
                   $valueObject->setIdStand($row[0]); 
                   $valueObject->setIdArtesano($row[1]); 
                   $valueObject->setReservado($row[2]); 
          } else {
    ...
    function listQuery($conn, $sql) {
          ...
          while ($row = $conn->nextRow($result)) {
               ...
               $temp->setIdStand($row[0]); 
               $temp->setIdArtesano($row[1]); 
               $temp->setReservado($row[2]); 
