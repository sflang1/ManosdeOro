<?php
 ...
 /**
  * Solicitud Data Access Object (DAO).
  * This class contains all database handling that is needed to 
  * permanently store and retrieve Solicitud object instances. 
  */
...
class SolicitudDao {
     ...
     */
    function getObject($conn, $idSolicitud) {

          $valueObject = $this->createValueObject();
          $valueObject->setIdSolicitud($idSolicitud);
    ...
    function load($conn, $valueObject) {
          ...
          if (!$valueObject->getIdSolicitud()) {
               //print "Can not select without Primary-Key!";
               return false;
          }

          $sql = "SELECT * FROM solicitud WHERE (idSolicitud = ".$valueObject->getIdSolicitud().") "; 
    ...
    function loadAll($conn) {
          ...
          $sql = "SELECT * FROM solicitud ORDER BY idSolicitud ASC ";
    ...
    function create($conn, $valueObject) {
          ...
          $sql = "INSERT INTO solicitud (idArtesano, idStand) VALUES ( ";
          $sql = $sql."".$valueObject->getIdArtesano().", ";
          $sql = $sql."".$valueObject->getIdStand().") ";
    ...
    function save($conn, $valueObject) {
          ...
          $sql = "UPDATE solicitud SET idArtesano = ".$valueObject->getIdArtesano().", ";
          $sql = $sql."idStand = ".$valueObject->getIdStand()."";
          $sql = $sql." WHERE (idSolicitud = ".$valueObject->getIdSolicitud().") ";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function delete($conn, $valueObject) {
          ...
          $sql = "DELETE FROM solicitud WHERE (idSolicitud = ".$valueObject->getIdSolicitud().") ";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function searchMatching($conn, $valueObject) {
          ...
          if ($valueObject->getIdSolicitud() != 0) {
              if ($first) { $first = false; }
              $sql = $sql."AND idSolicitud = ".$valueObject->getIdSolicitud()." ";
          }
          ...
          if ($valueObject->getIdStand() != 0) {
              if ($first) { $first = false; }
              $sql = $sql."AND idStand = ".$valueObject->getIdStand()." ";
          }


          $sql = $sql."ORDER BY idSolicitud ASC ";
    ...
    function singleQuery($conn, $sql, $valueObject) {
          ...
          if ($row = $conn->nextRow($result)) {
                   ...
                   $valueObject->setIdSolicitud($row[0]); 
                   $valueObject->setIdArtesano($row[1]); 
                   $valueObject->setIdStand($row[2]); 
          } else {
    ...
    function listQuery($conn, $sql) {
          ...
          while ($row = $conn->nextRow($result)) {
               ...
               $temp->setIdSolicitud($row[0]); 
               $temp->setIdArtesano($row[1]); 
               $temp->setIdStand($row[2]); 
