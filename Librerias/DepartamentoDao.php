<?php
 ...
 /**
  * Departamento Data Access Object (DAO).
  * This class contains all database handling that is needed to 
  * permanently store and retrieve Departamento object instances. 
  */
...
class DepartamentoDao {
     ...
     */
    function getObject($conn, $id_departamento) {

          $valueObject = $this->createValueObject();
          $valueObject->setId_departamento($id_departamento);
    ...
    function load($conn, $valueObject) {
          ...
          if (!$valueObject->getId_departamento()) {
               //print "Can not select without Primary-Key!";
               return false;
          }

          $sql = "SELECT * FROM departamentos WHERE (id_departamento = ".$valueObject->getId_departamento().") "; 
    ...
    function create($conn, $valueObject) {
          ...
          $sql = "INSERT INTO departamentos ( id_departamento, descripcion) VALUES (".$valueObject->getId_departamento().", ";
    ...
    function save($conn, $valueObject) {
          ...
          $sql = "UPDATE departamentos SET descripcion = '".$valueObject->getDescripcion()."'";
          $sql = $sql." WHERE (id_departamento = ".$valueObject->getId_departamento().") ";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function delete($conn, $valueObject) {
          ...
          $sql = "DELETE FROM departamentos WHERE (id_departamento = ".$valueObject->getId_departamento().") ";
          $result = $this->databaseUpdate($conn, $sql);
    ...
    function searchMatching($conn, $valueObject) {
          ...
          $sql = $sql."ORDER BY id_departamento ASC ";
    ...
    function singleQuery($conn, $sql, $valueObject) {
          ...
          if ($row = $conn->nextRow($result)) {
                   ...
                   $valueObject->setId_departamento($row[0]); 
