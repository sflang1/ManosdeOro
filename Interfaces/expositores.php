		...
		<div id="contenedor">
			...
			<section id="sec2">
				...
				<div style="float: right; width: 60%;">
					...
					<h1 id="titulos_inicio_sesion">Iniciar Sesion</h1>
					...
					<button type="submit" value="Aceptar" id="boton_iniciar" ><img id="logo_btn" src="../imgs/logo.png">Iniciar</button>
					</form>
					<br><br>
					<h1 id="creatucuenta">¿Olvidaste tu contraseña? Haz click </h1><a id="aqui" href="recuperarContrasena.php">Aquí</a>
					<br><br>
					<h1 id="creatucuenta">Aun No Tienes Una Cuenta? Creala</h1>
					<a href="Creacioncuenta.php" id="aqui"> Aqui</a>
				</div>
			</section>
			<footer>		
