...
<html>
	...
	<body  onload="initialize()">
		<div id="contenedor">
			...
			<section id="sec6">
			<br>
Bienvenido, <?php echo(utf8_encode($artesano->getNombre()));?>. En el siguiente formulario podrá subir su RUT y su registro de Cámara de Comercio.
						Recuerde que únicamente se permiten archivos tipo PDF.
						<form enctype="multipart/form-data" onsubmit="return validarForm()" method="POST" action="../Logica/subirDocumentos.php">
							<input type="hidden" name="id" value=<?php echo($artesano->getIdartesano());?>>
								<table>
									<tr>
										...
										<td>
											<input id="rut" type="file" name="rut">
										</td>
									</tr>
									<tr>
										<td>
											Sube aquí tu registro de Cámara de Comercio:
										</td>
										<td>
											<input type="file" name="camcom" id="camcom">
										</td>
									</tr>
									<tr>
										<td colspan="2">
						...
						<script type="text/javascript" src="subirDocumentos.js"></script>
			</section>
			<footer>		
