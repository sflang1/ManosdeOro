	...
	$.getJSON("../Logica/buscarArtesanosPorCriterio.php?criterio="+criterio+"&busqueda="+busqueda,
		function (result)
		{
			if(result.exito==1)
			{
				...
				cadena=cadena+"<tr><td style='border: 1px solid black; border-collapse: collapse; padding:5px;'>Nombre</td><td style='border: 1px solid black; border-collapse: collapse; padding:5px;'>Número de documento</td><td style='border: 1px solid black; border-collapse: collapse; padding:5px;'>Dirección</td><td style='border: 1px solid black; border-collapse: collapse; padding:5px;'>Teléfono</td><td style='border: 1px solid black; border-collapse: collapse; padding:5px;'>Celular</td><td style='border: 1px solid black; border-collapse: collapse; padding:5px;'>Email</td><td style='border: 1px solid black; border-collapse: collapse; padding:5px;'>Ciudad</td><td style='border: 1px solid black; border-collapse: collapse; padding:5px;'>Departamento</td><td style='border: 1px solid black; border-collapse: collapse; padding:5px;'>Camara y Comercio</td><td style='border: 1px solid black; border-collapse: collapse; padding:5px;'>RUT</td></tr>";
				var valores=result.valores;
				for (var i = valores.length - 1; i >= 0; i--) {
				cadena=cadena+"<tr><td style='border: 1px solid black; border-collapse: collapse; padding:5px;'>"+valores[i].nombre+"</td><td style='text-align: right; border: 1px solid black; border-collapse: collapse; padding:5px;'>"+valores[i].nroDoc+"</td><td style='text-align: right; border: 1px solid black; border-collapse: collapse; padding:5px;'>"+valores[i].direccion+"</td><td style='text-align: right; border: 1px solid black; border-collapse: collapse; padding:5px;'>"+valores[i].telefono+"</td><td style='text-align: right; border: 1px solid black; border-collapse: collapse; padding:5px;'>"+valores[i].celular+"</td><td style='text-align: right; border: 1px solid black; border-collapse: collapse; padding:5px;'>"+valores[i].email+"</td><td style='text-align: right; border: 1px solid black; border-collapse: collapse; padding:5px;'>"+valores[i].ciudad+"</td><td style='text-align: right; border: 1px solid black; border-collapse: collapse; padding:5px;'>"+valores[i].departamento+"</td><td style='border: 1px solid black; border-collapse: collapse; padding:5px;'><input type='button' value='Ver CamCom' onclick='window.location.href=\"../Archivos/camcom_"+valores[i].nroDoc+".pdf\"'></td><td style='border: 1px solid black; border-collapse: collapse; padding:5px;'><input type='button' value='Ver RUT' onclick='window.location.href=\"../Archivos/rut_"+valores[i].nroDoc+".pdf\"'></td></tr>"
				};
				cadena=cadena+"</table>";
				$("#lista").html(cadena);
			}
		...
		$.getJSON("../Logica/buscarArtesanosPorCriterio.php?criterio=2&busqueda=1",
			function (result)
			{
				if(result.exito==1)
				{
					...
					var valores=result.valores;
					for (var i = valores.length - 1; i >= 0; i--) {
						cadena=cadena+"<tr><td style='border: 1px solid black; border-collapse: collapse; padding:5px;'>"+valores[i].nombre+"</td><td style='border: 1px solid black; border-collapse: collapse; padding:5px;'>"+valores[i].nroDoc+"</td><td style='border: 1px solid black; border-collapse: collapse; padding:5px;'>"+valores[i].direccion+"</td><td style='border: 1px solid black; border-collapse: collapse; padding:5px;'>"+valores[i].telefono+"</td><td style='border: 1px solid black; border-collapse: collapse; padding:5px;'>"+valores[i].celular+"</td><td style='border: 1px solid black; border-collapse: collapse; padding:5px;'>"+valores[i].email+"</td><td style='border: 1px solid black; border-collapse: collapse; padding:5px;'>"+valores[i].ciudad+"</td><td style='border: 1px solid black; border-collapse: collapse; padding:5px;'>"+valores[i].departamento+"</td><td style='border: 1px solid black; border-collapse: collapse; padding:5px;'><input type='button' value='Ver CamCom' onclick='window.location.href=\"../Archivos/camcom_"+valores[i].nroDoc+".pdf\"'></td><td style='border: 1px solid black; border-collapse: collapse; padding:5px;'><input type='button' value='Ver RUT' onclick='window.location.href=\"../Archivos/rut_"+valores[i].nroDoc+".pdf\"'></td></tr>"
					};
					cadena=cadena+"</table>";
					$("#lista").html(cadena);
				}
