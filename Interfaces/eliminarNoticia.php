...
<html>
	...
	<body  onload="initialize()">
		<div id="contenedor">
			...
			<section id="sec6">
		La siguiente es la interfaz para eliminación de noticias.<br>
						Noticia a eliminar: <?php echo(utf8_encode($noticia->getTitulo()));?><br>
						¿Deseas confirmar la eliminación de esta noticia?
						<form action="../Logica/eliminarNoticia.php" method="POST">
							<table>
...
<br>
<br>
						<a id="boton_iniciar"href="admonNoticias.php">Volver Atras</a>
			</section>
			<footer>		
				<div style="float: left; width: 33%;">
