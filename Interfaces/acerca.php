			...
			<header>
				...
				<section id="sec2">	
					<?php
						...
						echo("<center><h2 id='titulos_footer'>".utf8_encode($somos->getTitulo())."</h2></center><center><h3 id='strings_editar'>".$somos->getContenido()."</h3></center>");
						echo ("<br>");
						echo ("<br>");
						echo("<center><h2 id='titulos_footer'>".utf8_encode($mision->getTitulo())."</h2></center><center><h3 id='strings_editar'>".$mision->getContenido()."</h3></center>");
						echo ("<br>");
						echo ("<br>");
						echo("<center><h2 id='titulos_footer'>".utf8_encode($vision->getTitulo())."</h2></center><center><h3 id='strings_editar'>".$vision->getContenido()."</h3></center>");
						?>
				</section>
			<footer>		
