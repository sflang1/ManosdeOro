...
<html>
	<head>
		<title>Manos de Oro - Admon Comision</title>
		...
		<div id="contenedor">
			...
			<section id="sec6">
				<center>
					...
					<h1 id="strings_editar_rojo">Este formulario cambiará la comisión que cobra Manos de Oro sobre todas las ventas en la tienda:</h1>
