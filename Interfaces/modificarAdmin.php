		...
		<div id="contenedor">
			...
			<section id="sec6">
				<center>
					...
					<form method="POST" action="../Logica/modificarAdmin.php">
						<table>
							<input type="hidden" name="idAdmin" value=<?php echo($adminmodificar->getIdAdministrador());?>>
							<tr>
								<td>Primer nombre: </td>
								<td><input type="text" name="primerNom" value=<?php echo(utf8_encode($adminmodificar->getPrimerNom()));?>></td>
							</tr>
							<tr>
								<td>Segundo nombre: </td>
								<td><input type="text" name="segundoNom" value=<?php echo(utf8_encode($adminmodificar->getSegundoNom()));?>></td>
							</tr>
							<tr>
								<td>Primer apellido: </td>
								<td><input type="text" name="primerApe" value=<?php echo(utf8_encode($adminmodificar->getPrimerApe()));?>></td>
							</tr>
							<tr>
								<td>Segundo apellido: </td>
								<td><input type="text" name="segundoApe" value=<?php echo(utf8_encode($adminmodificar->getSegundoApe()));?>></td>
							</tr>
							<tr>
								<td>Email: </td>
								<td><input type="email" name="email" value=<?php echo(utf8_encode($adminmodificar->getEmail()));?>></td>
							</tr>
							<tr>
								<td colspan='2'>
