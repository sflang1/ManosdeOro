...
<h1 id="strings_editar">Aquí está la lista de tus productos en la tienda virtual y el informe de ventas. tenga en cuenta que manos de oro toma un porcentaje por las ventas realizadas en esta tienda</h1>
						<table style="border: 2px solid black;border-collapse: collapse;">
							<tr style="border: 2px solid black;border-collapse: collapse;">
								<td id="strings_editar_rojo" style="border: 2px solid black;border-collapse: collapse;">
							...
							<?php
								for($i=0;$i<count($productosconstock);$i++)
								{
