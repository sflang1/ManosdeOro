			...
			case "1":
				$.getJSON("../Logica/listarArtesanos.php",
					function (result)
					{
						...
						{
							cadena="";
							cadena=cadena+"<table><tr><td><select id='selectBuscar' onChange='limpiarBusqueda()'><option value='1'>Buscar por cédula</option><option value='2'>Buscar por ciudad</option><option value='3'>Buscar por nombre</option></select></td><td><div id='campoEntrada'> <input type='text' id='busqueda' onkeyup='buscar()'></div></td><td><input type='button' onClick='buscar()' value='Buscar'></td></tr></table>";
