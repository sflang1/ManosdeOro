	...
	if(isset($_SESSION["USER"]))
	{
		...
		else
		{
			if(isset($_POST['id']))
			{
				...
				$noticia=$ndao->getObject($conn,$idnoticia);
				?>
...
<html>
	...
	<body  onload="initialize()">
		<div id="contenedor">
			...
			<aside>
				<ul>
					<li><a id="opc_admin" href="admon.php">Inicio</a></li>
					<li><a id="opc_admin" href="admonNoticias.php">Noticias</a></li>
					<li><a id="opc_admin" href="cambiarInstitucional.php">Informacion Institucional</a></li>
					<li><a id="opc_admin" href="peticionesRegistro.php">Peticiones de registro</a></li>
					<li><a id="opc_admin" href="verVentasAdmin.php">Ver reporte total de ventas</a><br></li>
					<li><a id="opc_admin" href="confirmarStands.php">Confirmar solicitudes de reserva de stands</a><br></li>
					<li><a id="opc_admin" href="agregarCurso.php">Agregar un curso</a><br></li>
					<li><a id="opc_admin" href="cambiarComision.php">Comision Tienda Virtual</a><br></li>
				</ul>
			</aside>
			...
			<section id="sec6">
				<center>
<br><br>
						<h1 id="strings_editar"> Noticia a modificar:</h1> <?php echo(utf8_encode($noticia->getTitulo()));?><br><br>

<hr>
<br>
						<h1 id="strings_editar">Introduzca los siguientes datos. Si no planeas cambiar, deja el campo vacío:</h1>
						<form action="../Logica/modificarNoticia.php" method="POST">
							<table>
								<input type='hidden' value=<?php echo($idnoticia);?> name='id'>
								<tr>
									<td>
...
<br>
						...
						<a id="boton_iniciar" href="admonNoticias.php">Volver al Menu Anterior</a>
				</center>
			</section>
			<footer>		
				<div style="float: left; width: 33%;">
