		...
		<div id="contenedor">
			...
			<section id="sec6">
				<center>
					...
					<h1 id="strings_editar_rojo">Aquí se encuentran las peticiones de registro pendientes:</h1><br>
<hr>
					<div id="tabla">
						<?php
							$busqueda=new Producto();
							$busqueda->setAceptado(0);
							$prodnoaceptados=$pdao->searchMatching($conn,$busqueda);
							if(count($prodnoaceptados)!=0)
							{
								?>
									<table >
										...
										<?php
											for($i=0;$i<count($prodnoaceptados);$i++)
											{

												if($prodnoaceptados[$i]->getAceptado()==0)
												{
...
<hr>
					...
					<script type="text/javascript" src="peticionesRegistro.js"></script>
				</center>
			</section>
			<footer>		
