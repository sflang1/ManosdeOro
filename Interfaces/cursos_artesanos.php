...
<hr>
		<?php
			for($i=0;$i<count($lista);$i++)
			{
				...
				echo("<br><button onclick=\"window.location.href='form_cursos_art.php?nomCurso=".$lista[$i]->getDescripcion()."'\" id='boton_iniciar'><img id='logo_btn' src='../imgs/logo.png'>Registro</button>");
