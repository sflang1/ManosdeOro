...
<html>
	...
	<body  onload="initialize()">
		<div id="contenedor">
			...
			<section id="sec6">
				<center>
					<h1 id="titulos_noticias">En este menú puedes agregar un nuevo perfil. Especifica un nombre y los permisos que tendrá este perfil:</h1>
					<form method="POST" action="../Logica/creacionPerfil.php">
						<table>
							<tr>
								<td>
									Nombre del perfil:
								...
								<td>
									<input type="text" name="nomPerfil">
								</td>
							</tr>
						</table>
						<table>
							...
							<tr>
								...
								<td style=" text-align:center;">
									<input type="radio" name="agregarProducto" value="0" checked>
								</td>
								<td style=" text-align:center;">
									<input type="radio" name="agregarProducto" value="1">
								</td>
							</tr>
							<tr>
								<td>
								...
								<td style=" text-align:center;">
									<input type="radio" name="registroVentas" value="0" checked>
								</td>
								<td style=" text-align:center;">
									<input type="radio" name="registroVentas" value="1">
								</td>
							</tr>
							<tr>
								<td>
									Confirmación reservas stands
								</td>
								<td style=" text-align:center;">
									<input type="radio" name="reservasStand" value="0" checked>
								</td>
								<td style=" text-align:center;">
									<input type="radio" name="reservasStand" value="1">
								</td>
							</tr>
							<tr>
								<td>
								...
								<td style=" text-align:center;">
									<input type="radio" name="editarPerfil" value="0" checked>
								</td>
								<td style=" text-align:center;">
									<input type="radio" name="editarPerfil" value="1">
								</td>
							</tr>
							<tr>
								<td>
								...
								<td style=" text-align:center;">
									<input type="radio" name="admonCursos" value="0" checked>
								</td>
								<td style=" text-align:center;">
									<input type="radio" name="admonCursos" value="1">
								</td>
							</tr>
							<tr>
								<td colspan="3">
