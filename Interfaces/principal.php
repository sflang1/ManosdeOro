			...
			<br>
						...
						<?php
							switch ($artesano->getEstado()) {
								...
								case 1:
									?>
									<a href="subirDocumentos.php">Terminar proceso de inscripción</a><br>
									<?php
									break;
								case 0:
									?>
									<h1 id="titulos_detalles">Es necesario que tu producto sea aceptado por un administrador para que accedas a las funciones adicionales.</h1><br>
									<?php
									break;
								case -1:
									?>
									<h1 id="titulos_detalles">Tu producto fue rechazado. Por favor, intenta enviando otro producto.</h1><br>
									<a href="registroProducto.php">Agregar un nuevo producto</a><br>
									<?php
								default:
									?>
									<h1 id="titulos_detalles">Estado inesperado.</h1>
									<?php
									break;
							}
							?>
							<div id="notificaciones">
							<br><h1 id="titulos_detalles">Estado de tus productos:</h1><br>
							<table>
							<?php
								$cadena="";
								for($i=0;$i<count($productos);$i++)
								{
									$cadena=$cadena."<tr><td>Tu producto: ".$productos[$i]->getDescripcion()." ";
									switch ($productos[$i]->getAceptado()) 
									{
										case -1:
											$cadena=$cadena."fue rechazado. </td><td>"."<input type='button' value='Quitar notificación' onclick='borrarNotificacion(".$productos[$i]->getIdproducto().")'></td></tr>";
											break;
										case 0:
											$cadena=$cadena."está en tramite de ser aceptado.</td><td> "."<input type='button' value='Quitar notificación' onclick='borrarNotificacion(".$productos[$i]->getIdproducto().")'></td></tr>";
											break;
										case 1:
											$estado=true;
											$cadena=$cadena."fue aceptado.</td><td><input type='button' value='Ingresar el stock' onclick=\"window.location.href='ingresarStock.php?id=".$productos[$i]->getIdproducto()."'\"></td></tr>";	
											break;
										case 2:
											$estado=true;
											$cadena=$cadena."ya está en la tienda.</td><td><input type='button' value='Quitar notificación' onclick='borrarNotificacion(".$productos[$i]->getIdproducto().")'></td></tr>";
											break;
										case 3:
											$estado=true;
											$cadena=$cadena."tiene existencias agotadas.</td><td><input type='button' value='Ingresar nuevo stock' onclick=\"window.location.href='ingresarStock.php?id=".$productos[$i]->getIdproducto()."'\"></td></tr>";
											break;
										default:
											$cadena=$cadena."Error en el estado";
											break;
									}
									if($ver)
									{
