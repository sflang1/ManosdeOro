	...
	<body>
		<div id="contenedor2">
			...
			<section id="sec5">
				...
				<h1 id="titulos_acerca">Por favor, introduce tu documento de identidad:</h1><br>
				<center>
		<form method="POST" action="../Logica/recuperarContrasena.php">
		<select name="tipo">
		...
		<input type="submit" value="Enviar" id="boton_iniciar">
		</form>
		<h1 id="creatucuenta">La contraseña sera enviada al correo que inscribiste en nuestra base de datos</h1>
		</center>
			</section>
		</div>
	</body>	
